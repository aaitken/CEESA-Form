<title>Untitled Document</title><?php
			...
			$message .= '<table border="0" cellspacing="5" style="margin-bottom:30px;">';
			$message .= "<tr style='background: #888; color:#fff; text-align:left;'><th colspan='5'>Conference Attendees</th></tr>";
			
			
			
			$message .= "<tr><td style='background:#E5E5E5 none repeat scroll 0 0; border:1px solid #D9D9D9; padding:2px 6px 5px;'><span>Name</span></td>";
			
			$message .= "<td style='background:#E5E5E5 none repeat scroll 0 0; border:1px solid #D9D9D9; padding:2px 6px 5px;'><span>Email</span></td>";		
			...
			// Cost
			$message .= '<table border="0" cellspacing="5" style="margin-bottom:30px;">';
			$message .= "<tr style='background: #000; color:#fff; text-align:left;'><th colspan='1'>Total Estimated Cost</th></tr>";
			...
			$subject =  strip_tags($_POST['step0_school']) . " CEESA Conference Registration Confirmation";
			
			$headers = "From: " . "confirmation@ceesa.org" . "\r\n";
			$headers .= "MIME-Version: 1.0\r\n";
			$headers .= "Content-Type: text/html; charset=ISO-8859-1\r\n";

            if (mail($to, $subject, $message, $headers)){
            	echo '<li>' . $_POST['successMessage'] . '</li><li>Your confirmation email has been sent to ' . strip_tags($_POST['step0_email']) .'.</li><li>We look forward to seeing you at the conference.</li>';
			} 
			else{
