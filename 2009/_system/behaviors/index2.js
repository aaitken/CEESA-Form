						...
						(function(){
							...
							switch(i){
								case 0:
									...
									break;
								case 1:
									$('#step1 input').each(function(){$.validationEngine.loadValidation($(this));errorTest();})
									$('#step1 select').each(function(){$.validationEngine.loadValidation($(this));errorTest();})		
									if(errorsOnStep===true){
										validation.initInline();
										return;
									}//===============================================================>
