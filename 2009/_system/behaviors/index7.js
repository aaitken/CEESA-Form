						...
						(function(){
							...
							switch(i){
								...
								case 2://Next Button on Pre-Conf/Inst Page
									...
									$('#ama-next').html('Confirm and Send').attr({
										type:'submit',
										name:'sumbit'
    ...
    $('#pageForm').ajaxForm({ 
        ...
        success: function() {
			...
			$('#ama-next')
				...
				.html('Return to CEESA.org')
				.click(function(){window.location.href='http://www.ceesa.org/conference_2010.html'});		
			$('#responseTarget').show();
			$('#step4').show();//hide current fieldset.show();	
        } 
    }); 
});